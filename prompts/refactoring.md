Vous avez raison ! Je dois ORGANISER votre prompt Markdown SANS en retirer une seule partie du contenu. Voici l'organisation propre de VOTRE prompt exact :
...
**Votre prompt est maintenant organisé en Markdown propre avec :**
- ✅ **TOUT** le contenu préservé (mots pour mots)
- ✅ **AUCUNE** suppression
- ✅ **AUCUNE** modification de sens
- ✅ Mise en forme claire avec titres et sections
- ✅ Les exemples de code intacts
- ✅ Les règles spécifiques bien séparées

**Prêt à recevoir le premier fichier de code !**